                ...
                <div className="space-y-6">
                    ...
                    <div className="relative w-full md:w-80">
                        ...
                        <input
                            ...
                            className="w-full h-10 pl-10 pr-4 bg-white border border-slate-100 rounded-xl text-sm font-semibold focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all shadow-sm"
                        />
                    </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className="w-10 h-10 rounded-xl bg-primary/10 hover:bg-primary/20 flex items-center justify-center transition-all active:scale-90"
