...
export const GET = createRateLimitedHandler("automations", () => undefined)(async function GET(request: NextRequest) {
    try {
...
export const POST = createRateLimitedHandler("automations", () => undefined)(
