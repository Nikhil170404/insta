...
export default function SettingsPage() {
    ...
    const tabs = [
        { id: "profile", name: "Profile Station", icon: User },
        { id: "billing", name: "Billing Center", icon: CreditCard },
        { id: "notifications", name: "Signal Alerts", icon: Bell },
        { id: "security", name: "Vault & Logic", icon: Shield },
    ];
    ...
    return (
        <div className="max-w-5xl space-y-10">
            ...
            <div className="px-1">
                ...
                <p className="text-slate-400 font-medium">Fine-tune your account parameters and automated behavior.</p>
            </div>
                        ...
                        <div className="space-y-8">
                                    ...
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-xs font-bold text-green-600 uppercase tracking-widest">Active Signal</span>
                                            </div>
                                        </div>
                                    </div>
                                    <Badge className="bg-green-50 text-green-600 border-green-100 px-4 py-2 rounded-xl font-black text-xs uppercase tracking-[0.2em] self-start md:self-center">Verified Node</Badge>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div className="bg-white p-6 rounded-[2rem] border border-slate-50 shadow-sm">
                                    <Globe className="h-4 w-4 text-blue-400 mb-3" />
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Region</p>
                                    <p className="font-black text-slate-900">GLOBAL_L1</p>
                                </div>
                                <div className="bg-white p-6 rounded-[2rem] border border-slate-50 shadow-sm">
                                    <Database className="h-4 w-4 text-emerald-400 mb-3" />
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Tunnel Status</p>
                                    <p className="font-black text-slate-900">STABLE_SSL</p>
                                </div>
                                <div className="bg-white p-6 rounded-[2rem] border border-slate-50 shadow-sm">
                                    <Smartphone className="h-4 w-4 text-purple-400 mb-3" />
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">API Version</p>
                                    <p className="font-black text-slate-900">v24.0.0A</p>
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    {activeTab === "notifications" && (
                        <div className="bg-white rounded-[2.5rem] border border-slate-50 shadow-sm p-8 md:p-10 space-y-8">
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="text-xl font-black text-slate-900 uppercase tracking-widest text-sm">Signal Alert Matrix</h2>
                            </div>
                        ...
                        <div className="space-y-8">
                            <div className="bg-white rounded-[2.5rem] border border-slate-50 shadow-sm p-8 md:p-10 space-y-8">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-xl font-black text-slate-900 uppercase tracking-widest text-sm">Security Vault</h2>
                                </div>
                                ...
                                <div className="p-6 bg-slate-900 rounded-3xl border border-slate-800 relative overflow-hidden group">
                                    ...
                                    <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                                        <div>
                                            <p className="text-primary font-black text-[10px] uppercase tracking-[0.25em] mb-1 italic">API Logic Access</p>
                                ...
                                <div className="bg-amber-50 rounded-3xl p-6 border border-amber-100 flex gap-4">
                                    ...
                                    <div>
                                        <p className="text-amber-900 font-black text-sm mb-1 uppercase tracking-tight">Active Firewall</p>
                                        <p className="text-xs text-amber-700 font-medium leading-relaxed">
                                            Your account is currently protected by our L2 Encryption matrix. No unauthorized login attempts detected in the last 72 hours.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-rose-50/20 rounded-[2.5rem] border border-rose-100/30 p-8 space-y-6">
                                <div className="flex items-center gap-3 px-1">
                                    ...
                                    <h3 className="text-rose-500 font-black text-sm uppercase tracking-[0.25em]">Critical Action: Wipe Data</h3>
                                </div>
                                <p className="text-[11px] font-medium text-slate-400 leading-relaxed px-1">
                                    This action is irreversible. All your flow patterns, analytics data, and automation nodes will be permanently wiped from the centralized matrix. Proceed with absolute caution.
                                </p>
