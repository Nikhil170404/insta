    ...
    return (
        <div className="min-h-screen bg-white flex flex-col selection:bg-primary selection:text-white overflow-x-hidden">
            ...
            <main className="flex-1 container mx-auto px-4 pt-48 pb-16 relative">
                ...
                {/* Story Grid */}
                <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto items-center mb-32">
                    ...
                    <div className="relative aspect-square">
                        <div className="absolute inset-0 bg-gradient-to-br from-primary to-indigo-600 rounded-[4rem] rotate-6 opacity-10 blur-2xl" />
                        <div className="relative h-full w-full bg-slate-900 rounded-[4rem] border border-white/10 flex flex-col items-center justify-center p-12 text-center overflow-hidden">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-primary/20 rounded-full blur-[80px] -mr-32 -mt-32" />
                            <Users className="h-20 w-20 text-primary mb-6 animate-pulse" />
                            <p className="text-3xl font-black text-white tracking-tight">Built by creators, for creators.</p>
                        </div>
                    </div>
                </div>

                {/* Values */}
                <div className="bg-slate-900 rounded-[5rem] p-12 md:p-32 text-center relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-[50rem] h-[50rem] bg-primary/10 rounded-full blur-[120px] -ml-[25rem] -mt-[25rem]" />
